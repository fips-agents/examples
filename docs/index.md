...
| [6. Extend with AI](06-extend-with-ai.md) | Use AI-assisted slash commands to add capabilities |
| [7. Production Hardening](07-secrets-and-production.md) | Secrets, FIPS, scaling, monitoring |
